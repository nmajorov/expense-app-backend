...
class ReportApiTest : OAuthTest() {
    ...
    fun testDeleteReport (){
        ...
        val reports = given().header("Authorization", "Bearer $TOKEN")
    ...
    fun testFindOneReport(){
        ...
        val result =  given().header("Authorization", "Bearer $TOKEN")
    ...
    fun testUpdateReport(){
        ...
        assert(lastReport.name == result.name)
